...
I work as a Java Software Developer. That being the case, I know comparatively little about Java[*](#note1). I'm much more versed in Objective-C, of all things, and in PHP, or even Python, than Java. As such I've had quite a few occasions I've needed to do some task or another and I'm at a loss for the Java method, so I put together this handy-dandy little guide.  
