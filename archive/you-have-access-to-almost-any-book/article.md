...
status: publish
hero: /images/blog/atoms-and-alchemy-desk.webp
thread: indie-research
...
<div class="image-right" style="width: 200px;">
  <img src="/images/blog/pricy-books.jpg" style="max-width: 100%;" alt="A real price tag on Amazon for a 200 page book: $198. Nearly a dollar per page.">
  <center><small style="line-height: 1.3; display: block;">The real price for a book I wanted to read. Photo: mine</small></center>
</div>
...
Assuming you live in a city or county connected to some segment of the Inter-Library Loan system (of which there are many), your [local city library][ill] can request books from basically anywhere, all for free or sometimes a modest fee (in San Diego it's $5 per request).

[ill]: https://www.sandiego.gov/public-library/services/lending/loan

From here, you leave the beaten path and venture into the rather informal system of ILL. San Diego, for example, has three methods of ILL depending on the reach you need and the speed at which you need the given book. For us, the Circuit system integrates with our local universities to get you quick access to books in their catalog, while the Link+ system has a broader reach. In the end though, if neither of those two have the book you want, you can use [WorldCat][wc]. WorldCat is a collection of catalogues from thousands of public libraries and colleges across the world. Given time to wait, you can get basically any book you want this way: including the "rare Ph.D. thesis that apparently only exists at the one person's alma-mater".

[wc]: https://search.worldcat.org

<div class="image-right" style="width: 300px;">
  <img src="/images/blog/atoms-and-alchemy-desk.webp" style="max-width: 100%; padding: 0;" alt="A picture of a book: Atoms and Alchemy sitting on a table beside a latte in the morning light.">
  <center><small style="line-height: 1.3; display: block;">One of many books I read via Inter-Library Loan. Photo: mine</small></center>
</div>
